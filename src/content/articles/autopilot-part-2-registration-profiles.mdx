...
In [Part 1](/deployment/autopilot-part-1-prerequisites/), we set up our prerequisites. Now it's time to register your first device in Intune and create a deployment profile that tells Autopilot how to configure new PCs.
...
In [Part 3](/deployment/autopilot-part-3-testing-troubleshooting/), we'll actually test the deployment, verify the device enrolls correctly, and troubleshoot common issues that might come up.
